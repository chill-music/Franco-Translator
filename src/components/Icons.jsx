/**
 * SVG icons replacing emoji (UX-3).
...
export function ChevronDownIcon({ size = 14, rotated = false }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={{ transform: rotated ? "rotate(180deg)" : "rotate(0)", display: "inline-block", transition: "0.2s" }}
    >
...
export function AndroidIcon({ size = 40 }) {
  return (
